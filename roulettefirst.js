const items = {
    ...
    "default": ["crc_book.png", "cr_bolotny_face.png", "crc_stupid.png", "cr_spiral.png"],
    "rare": ["cr_ghost.png", "cr_gradient.png", "crc_skull.png"],
    "secret": ["crc_cube.png", "crc_p2.png"],
    "legendary": ["cr_dragon.png"]

};

const chances = { // сумма всех чисел должна быть равна 1000
